...
sudo scutil --set ComputerName "logan-mac"
sudo scutil --set HostName "logan-mac"
sudo scutil --set LocalHostName "logan-mac"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "logan-mac"
